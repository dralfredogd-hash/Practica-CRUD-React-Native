...
export default function PaletizadoScreen() {
  ...
  const handleSaveReport = async () => {
    try {
      const tableFields = ['dia', 'turno', 'producto', 'operadores', 'kg', 'paroMec', 'paroElect'];
      ...
      await saveReportToDB(rows, REPORT_TYPES.PELETIZADO);
    } catch (error) {
  ...
  const handleGenerateExcel = async () => {
    try {
      ...
      return await generateExcelReport(rows, REPORT_TYPES.PELETIZADO);
    } catch (error) {
        ...
        <View style={styles.formRow}>
          ...
          <View style={styles.inputGroupSmall}>
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput style={styles.input} value={item.producto} onChangeText={(t) => updateRow(item.id, 'producto', t)} placeholder="Nombre del producto" placeholderTextColor="#999" />
            </View>
          </View>
          ...
          <View style={styles.inputGroupSmall}>
            ...
            <View style={styles.inputContainer}>
              <Icon name="group" size={18} color="#666" style={styles.inputIcon} />
              <TextInput style={styles.input} value={item.operadores} onChangeText={(t) => updateRow(item.id, 'operadores', t)} placeholder="Nombres separados por coma" placeholderTextColor="#999" />
            </View>
          </View>
          ...
          <View style={styles.rowSmall}>
            <View style={[styles.inputGroupSmall, { flex: 1, marginRight: 8 }]}>
            ...
            <View style={[styles.inputGroupSmall, { flex: 1, marginLeft: 8 }]}>
              <Text style={styles.inputLabel}>Paro elect</Text>
              <View style={styles.inputContainer}>
                <Icon name="power" size={18} color="#666" style={styles.inputIcon} />
  ...
  return (
    <View style={[styles.container, { backgroundColor: palette.bg }]}>
      <Header title="Reporte Peletizado" subtitle="Registro diario - Peletizado" />
      <FlatList
        data={rows}
...
const styles = StyleSheet.create({
  ...
  checkbox: { width: 24, height: 24, borderRadius: 4, borderWidth: 2, borderColor: '#ddd', alignItems: 'center', justifyContent: 'center', marginRight: 12, marginTop: 12 },
  ...
  inputContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#f6f6f6', paddingHorizontal: 10, borderRadius: 8 },
  inputIcon: { marginRight: 8 },
  input: { flex: 1, paddingVertical: 10, color: '#333' },
  rowSmall: { flexDirection: 'row' },
});
